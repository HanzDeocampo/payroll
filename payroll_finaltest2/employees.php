...
<div style="background:#fff; border-radius:16px; width:100%; max-width:860px; margin:0 auto; box-shadow:0 25px 50px rgba(0,0,0,0.25); overflow:hidden;">
    ...
    <form method="POST" onsubmit="return validateAddForm(this)">
        ...
        <div class="modal-body">
            ...
            <div class="form-row">
                <div class="form-group"><label class="form-label">Date of Birth <span style="color:red">*</span></label><input type="date" name="date_of_birth" id="add_dob" class="form-control" required onchange="calculateAge(this.value,'add_age_display')"></div>
            ...
            <div class="form-row">
                ...
                <div class="form-group"><label class="form-label">Date of Appointment</label><input type="date" name="date_hired" class="form-control"></div>
            </div>
            <div class="form-group">
                <label class="form-label">Address</label>
                <select name="add_barangay" id="add_barangay" class="form-control" style="margin-bottom:6px;" onchange="buildAddress('add')" required>
<option value="">-- Select Barangay --</option>
<option value="Barangay 1">Barangay 1, Bacolod City</option>
<option value="Barangay 2">Barangay 2, Bacolod City</option>
<option value="Barangay 3">Barangay 3, Bacolod City</option>
<option value="Barangay 4">Barangay 4, Bacolod City</option>
<option value="Barangay 5">Barangay 5, Bacolod City</option>
<option value="Barangay 6">Barangay 6, Bacolod City</option>
<option value="Barangay 7">Barangay 7, Bacolod City</option>
<option value="Barangay 8">Barangay 8, Bacolod City</option>
<option value="Barangay 9">Barangay 9, Bacolod City</option>
<option value="Barangay 10">Barangay 10, Bacolod City</option>
<option value="Barangay 11">Barangay 11, Bacolod City</option>
<option value="Barangay 12">Barangay 12, Bacolod City</option>
<option value="Barangay 13">Barangay 13, Bacolod City</option>
<option value="Barangay 14">Barangay 14, Bacolod City</option>
<option value="Barangay 15">Barangay 15, Bacolod City</option>
<option value="Barangay 16">Barangay 16, Bacolod City</option>
<option value="Barangay 17">Barangay 17, Bacolod City</option>
<option value="Barangay 18">Barangay 18, Bacolod City</option>
<option value="Barangay 19">Barangay 19, Bacolod City</option>
<option value="Barangay 20">Barangay 20, Bacolod City</option>
<option value="Barangay 21">Barangay 21, Bacolod City</option>
<option value="Barangay 22">Barangay 22, Bacolod City</option>
<option value="Barangay 23">Barangay 23, Bacolod City</option>
<option value="Barangay 24">Barangay 24, Bacolod City</option>
<option value="Barangay 25">Barangay 25, Bacolod City</option>
<option value="Barangay 26">Barangay 26, Bacolod City</option>
<option value="Barangay 27">Barangay 27, Bacolod City</option>
<option value="Barangay 28">Barangay 28, Bacolod City</option>
<option value="Barangay 29">Barangay 29, Bacolod City</option>
<option value="Barangay 30">Barangay 30, Bacolod City</option>
<option value="Barangay 31">Barangay 31, Bacolod City</option>
<option value="Barangay 32">Barangay 32, Bacolod City</option>
<option value="Barangay 33">Barangay 33, Bacolod City</option>
<option value="Barangay 34">Barangay 34, Bacolod City</option>
<option value="Barangay 35">Barangay 35, Bacolod City</option>
<option value="Barangay 36">Barangay 36, Bacolod City</option>
<option value="Barangay 37">Barangay 37, Bacolod City</option>
<option value="Barangay 38">Barangay 38, Bacolod City</option>
<option value="Barangay 39">Barangay 39, Bacolod City</option>
<option value="Barangay 40">Barangay 40, Bacolod City</option>
<option value="Alijis">Alijis, Bacolod City</option>
<option value="Banago">Banago, Bacolod City</option>
<option value="Bata">Bata, Bacolod City</option>
<option value="Cabug">Cabug, Bacolod City</option>
<option value="Estefania">Estefania, Bacolod City</option>
<option value="Granada">Granada, Bacolod City</option>
<option value="Handumanan">Handumanan, Bacolod City</option>
<option value="Mansilingan">Mansilingan, Bacolod City</option>
<option value="Montevista">Montevista, Bacolod City</option>
<option value="Pahanocoy">Pahanocoy, Bacolod City</option>
<option value="Punta Taytay">Punta Taytay, Bacolod City</option>
<option value="Singcang-Airport">Singcang-Airport, Bacolod City</option>
<option value="Sum-ag">Sum-ag, Bacolod City</option>
<option value="Taculing">Taculing, Bacolod City</option>
<option value="Tangub">Tangub, Bacolod City</option>
<option value="Villamonte">Villamonte, Bacolod City</option>
<option value="Vista Alegre">Vista Alegre, Bacolod City</option>
                </select>
                <input type="text" id="add_street" class="form-control" placeholder="Street / Purok / House No. (optional)" oninput="buildAddress('add')">
...
<div style="background:#fff; border-radius:16px; width:100%; max-width:860px; margin:0 auto; box-shadow:0 25px 50px rgba(0,0,0,0.25); overflow:hidden;">
    ...
    <form method="POST" action="employees.php?department_id=<?php echo $selectedDeptId; ?>" onsubmit="return validateEditForm(this)">
        ...
        <div class="modal-body">
            ...
            <div class="form-row">
                <div class="form-group"><label class="form-label">Date of Birth <span style="color:red">*</span></label><input type="date" name="date_of_birth" id="edit_dob" class="form-control" required onchange="calculateAge(this.value,'edit_age_display')"></div>
            ...
            <div class="form-row">
                ...
                <div class="form-group"><label class="form-label">Date of Appointment</label><input type="date" name="date_hired" id="edit_date_hired" class="form-control"></div>
            </div>
            <div class="form-group">
                <label class="form-label">Address</label>
                <select name="edit_barangay" id="edit_barangay" class="form-control" style="margin-bottom:6px;" onchange="buildAddress('edit')">
<option value="">-- Select Barangay --</option>
...
<option value="Vista Alegre">Vista Alegre, Bacolod City</option>
                ...
                <input type="text" id="edit_street" class="form-control" placeholder="Street / Purok / House No. (optional)" oninput="buildAddress('edit')">
...
function editEmployee(data) {
    ...
    // Parse address into barangay + street
    parseAddress(data.address || '', 'edit');
...
function buildAddress(prefix) {
    var sel = document.getElementById(prefix + '_barangay');
    if (sel && sel.value) sel.style.border = '';
    var barangay = document.getElementById(prefix + '_barangay').value;
    var street   = (document.getElementById(prefix + '_street').value || '').trim();
    var full = '';
    if (street)   full += street + ', ';
    if (barangay) full += barangay + ', Bacolod City, Negros Occidental';
    document.getElementById(prefix + '_address_hidden') 
        ? document.getElementById(prefix + '_address_hidden').value = full
        : document.getElementById(prefix + '_address').value = full;
}

function parseAddress(address, prefix) {
    var barangays = ["Alijis", "Banago", "Barangay 1", "Barangay 10", "Barangay 11", "Barangay 12", "Barangay 13", "Barangay 14", "Barangay 15", "Barangay 16", "Barangay 17", "Barangay 18", "Barangay 19", "Barangay 2", "Barangay 20", "Barangay 21", "Barangay 22", "Barangay 23", "Barangay 24", "Barangay 25", "Barangay 26", "Barangay 27", "Barangay 28", "Barangay 29", "Barangay 3", "Barangay 30", "Barangay 31", "Barangay 32", "Barangay 33", "Barangay 34", "Barangay 35", "Barangay 36", "Barangay 37", "Barangay 38", "Barangay 39", "Barangay 4", "Barangay 40", "Barangay 5", "Barangay 6", "Barangay 7", "Barangay 8", "Barangay 9", "Bata", "Cabug", "Estefania", "Granada", "Handumanan", "Mansilingan", "Montevista", "Pahanocoy", "Punta Taytay", "Singcang-Airport", "Sum-ag", "Taculing", "Tangub", "Villamonte", "Vista Alegre"];
    var barangaySel = document.getElementById(prefix + '_barangay');
    var streetInp   = document.getElementById(prefix + '_street');
    var hiddenInp   = document.getElementById(prefix + '_address') || document.getElementById(prefix + '_address_hidden');
    if (hiddenInp) hiddenInp.value = address;
    var found = '';
    barangays.forEach(function(b) {
        if (address.indexOf(b) !== -1) found = b;
    });
    if (barangaySel) barangaySel.value = found;
    if (streetInp) {
        if (found) {
            var idx = address.indexOf(found);
            streetInp.value = idx > 0 ? address.substring(0, idx).replace(/,\s*$/, '').trim() : '';
        } else {
            streetInp.value = address;
        }
    }
}

function validateAddForm(form) {
    var barangay = document.getElementById('add_barangay').value;
    if (!barangay) {
        document.getElementById('add_barangay').style.border = '2px solid #ef4444';
        document.getElementById('add_barangay').focus();
        alert('Please select a Barangay for the address.');
        return false;
    }
    document.getElementById('add_barangay').style.border = '';
    buildAddress('add');
    return true;
}
...
function validateEditForm(form) {
    ...
    if (!barangay) {
        document.getElementById('edit_barangay').style.border = '2px solid #ef4444';
        document.getElementById('edit_barangay').focus();
        alert('Please select a Barangay for the address.');
        return false;
    }
    document.getElementById('edit_barangay').style.border = '';
    buildAddress('edit');
    return true;
}
